...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    *                                                                                   generated by [keymapviz] */
    [_QWERTY] = LAYOUT_ferris_base_wrapper(
        ...
        _______________QWERTY_HMR_L2_______________, _______________QWERTY_HMR_R2_______________,
    ...
    *                             `-----------'        `-----------'
    *                                                                                   generated by [keymapviz] */
        __________________TAB_NAV__________________, _________________VIM_ARROW_________________,
        __________________WWW_NAV__________________, ___________________ARROW___________________,
        ________________MOUSE_WHEEL________________, _________________MOUSE_NAV_________________
    ),
